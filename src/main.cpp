...
DigitalOut LEDout2(LED2); //will provide the load signal
DigitalOut LEDout3(LED3); //will provide the load signal
DigitalOut LEDout4(LED4); //will provide the load signal
